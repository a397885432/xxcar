...
#THROTTLE_FORWARD_PWM = 458      #pwm value for max forward throttle
THROTTLE_FORWARD_PWM = 404      #pwm value for max forward throttle
THROTTLE_STOPPED_PWM = 324      #pwm value for no movement
THROTTLE_REVERSE_PWM = 244      #pwm value for max reverse throttle
#THROTTLE_REVERSE_PWM = 187      #pwm value for max reverse throttle
# 
